...
## Инженерные правила
- Любые кодовые изменения выполнять только в `feature/*`-ветках.
- Если активна ветка `main`, сначала создать и переключиться на новую ветку `feature/<task-name>`, и только после этого вносить изменения.
